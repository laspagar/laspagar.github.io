...
> **Luas Area (Panjang x Lebar) x Harga Satuan per m²**

Tapi, "Harga Satuan" inilah kuncinya. Ia ditentukan oleh 3 faktor:
1.  **Jenis Rangka** (Tulang punggung kanopi)
...
## 1. Biaya Berdasarkan Jenis Atap (Paling Menentukan)

### A. Kanopi Atap Spandek (Budget Option)
Pilihan paling ekonomis. Terbuat dari zincalume tipis.
*   **Kelebihan**: Sangat murah, awet (anti karat), ringan.
...
*   **Kelebihan**: Mewah, modern, pencahayaan alami maksimal (skylight).
...
## 3. Biaya Tambahan (Hidden Cost)

Hati-hati, kadang ada biaya yang tidak disebutkan di awal:
*   **Tiang V / Double**: Jika ingin model tiang yang artistik, biasanya ada charge tambahan Rp 200rb - 500rb per tiang.
*   **Talang Air**: Standarnya talang PVC biasa. Jika ingin talang plat galvanis tekuk (kotak) yang rapi, ada biaya ekstra per meter lari.
*   **Plafon PVC**: Ingin kanopi rapi seperti plafon rumah? Tambah **Rp 350.000 - Rp 500.000 / m²**. Lihat contohnya di [Kanopi Kordoba](/products/kanopi-kordoba-plafon-pvc).
*   **Jasa Bongkar Kanopi Lama**: Jika ada kanopi lama yang harus dibongkar, biasanya ada ongkos bongkar borongan (Sekitar Rp 300rb - 700rb).

---

## Simulasi Hitung Budget (Contoh Kasus)

Pak Budi di Antapani ingin pasang kanopi carport ukuran **4m x 5m** (Luas 20 m²).
Beliau ingin yang adem dan tidak berisik (Pilih **Alderon**).

*   **Opsi 1 (Model Standar)**:
    *   Harga Rp 950.000 x 20 m² = **Rp 19.000.000**.
    *   *Sudah terima bersih.*

*   **Opsi 2 (Model Kordoba Premium + Plafon PVC)**:
    *   Harga Rp 1.500.000 x 20 m² = **Rp 30.000.000**.
    *   *Hasil mewah seperti ruang tamu outdoor.*

---

## Tips Hemat Budget dari Tukang Las

1.  **Pilih Atap Spandek Pasir**: Jika budget mepet tapi gak mau berisik, Spandek Pasir adalah jalan tengah. Harganya cuma beda dikit dari spandek biasa, tapi suaranya jauh lebih redam.
2.  **Kurangi Tiang**: Kalau posisi carport diapit dua dinding, tempelkan rangka ke dinding (gunakan dynabolt). Anda hemat biaya besi untuk tiang.
