            ...
            <div class="relative z-10">
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                    <div class="bg-slate-800 p-4 rounded-lg">
                        <p class="text-blue-400 font-bold mb-2">📞 Telepon</p>
                        <p class="text-gray-200">081316777302</p>
                    </div>
                    <div class="bg-slate-800 p-4 rounded-lg">
                    ...
                    <div class="bg-slate-800 p-4 rounded-lg">
                        ...
                        <p class="text-gray-200"><a href="https://share.google/CTaofW0eEruAr9mio" class="hover:text-blue-400">Buka Lokasi</a></p>
                    </div>
                </div>
            </div>
        </div>
