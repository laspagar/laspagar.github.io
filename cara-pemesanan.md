...
<div class="test2-theme">
    <div class="container py-12 max-w-4xl">
        ...
        <div class="bg-blue-50 rounded-xl p-8 text-center border border-blue-100">
            ...
            <a href="https://wa.me/6285181814469?text=Halo%20Kinglas%20Tehnik,%20saya%20mau%20tanya%20harga%20untuk%20pembuatan..." class="inline-flex items-center bg-blue-600 text-white px-8 py-4 rounded-full font-bold shadow-lg hover:bg-blue-700 transition-colors">
